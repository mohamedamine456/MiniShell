...
#    Updated: 2021/03/31 08:57:22 by mlachheb         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
PARSE_SRC = parse/check_options.c parse/clean_tab_cmd.c parse/cmd_add_back.c\
			parse/cmd_functions_test.c parse/cmd_last.c parse/cmd_size.c\
			parse/free_cmd.c parse/new_cmd.c parse/parse_command.c\
			parse/print_cmd.c parse/replace_tab_env.c

GNL_SRC = get_next_line/get_next_line.c
SRC = $(PARSE_SRC) $(GNL_SRC)

PARSE_OBJSRC = parse_command.o cmd_add_back.o check_options.o cmd_functions_test.o\
			   cmd_last.o cmd_size.o free_cmd.o new_cmd.o print_cmd.o\
			   replace_tab_env.o clean_tab_cmd.o
