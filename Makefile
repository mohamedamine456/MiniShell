...
#    Updated: 2021/04/19 16:41:03 by mlachheb         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
TERMINAL_SRC = terminal/check_flags.c terminal/delete_char.c terminal/format_terminal.c\
			  terminal/read_line.c terminal/quit_d.c terminal/history_functions.c

GNL_SRC = get_next_line/get_next_line.c
SRC = $(PARSE_SRC) $(GNL_SRC) $(TERMINAL_SRC) rdwr_history.c
...
TERMINAL_OBJSRC = check_flags.o delete_char.o format_terminal.o\
				  read_line.o quit_d.o history_functions.o

GNL_OBJSRC = get_next_line.o
OBJSRC = $(PARSE_OBJSRC) $(GNL_OBJSRC) $(TERMINAL_OBJSRC) rdwr_history.o
